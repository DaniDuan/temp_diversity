...
# Save results
# =============================================================================
results_dir = joinpath(@__DIR__, "../../results/20260511/temp_rich_tro")
mkpath(results_dir)
@save joinpath(results_dir, "tro_iters_$(index).jld2") all_rich all_Shannon all_Simpson all_sur all_ext all_u all_m all_Eu all_Em all_Tpu all_Tpm # all_r_inv all_ϵ 